...
export default async function Page({params}:{params:Promise<{id:string}>}){const {id}=await params;const i=await story(id);if(!i)notFound();return <BriefingReader initial={await briefingBatch(null,id)}/>;}
