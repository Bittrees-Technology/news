...
export async function publicFeedBatch(snapshot:string,before:string|null=null,category:FeedCategory='all'){
 ...
 ORDER BY published_at DESC,id DESC LIMIT 31`,[snapshot,before,category])).rows;
