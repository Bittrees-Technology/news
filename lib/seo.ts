...
export function pageMetadata(title:string, description:string, path:string): Metadata {
  ...
  return {title, description, alternates:{canonical:url},openGraph:{type:"website",siteName,title,description,url,locale:"en_GB",images:[{url:siteUrl+"/brand/social.png",width:1200,height:630,alt:"The Bittrees News — World, economy, technology and science"}]},twitter:{card:"summary_large_image",title,description,images:[siteUrl+"/brand/social.png"]}};
}
