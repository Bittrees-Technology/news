...
export const readerFiltersSchema=z.object({topics:choices,excludedTopics:choices,countries:choices,excludedCountries:choices,regions:choices,excludedRegions:choices,hideRead:z.boolean().default(true)});
