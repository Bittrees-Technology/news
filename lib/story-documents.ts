...
export async function saveStory(input:unknown){
 ...
 const payload={version:1,id:i.id,title:i.title,kind:i.kind,source:{url:i.url,authors:i.authors,publication:i.publication||sourceName(i.source_id),publishedAt:i.published_at},briefing:b.briefing,model:b.model,generatedAt:new Date().toISOString(),url:`https://news.bittrees.org/story/${i.id}`,notice:'AI-generated Bittrees briefing based on publisher-provided feed evidence. Not the original full article; consult the linked source.'};
